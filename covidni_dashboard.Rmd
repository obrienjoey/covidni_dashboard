...
national_df <- readr::read_csv("https://raw.githubusercontent.com/obrienjoey/covid19northernireland/main/data/ni_covid_national.csv")
last_national_data <- national_df %>% na.omit() %>% filter(date == max(date))

local_df <- readr::read_csv("https://raw.githubusercontent.com/obrienjoey/covid19northernireland/main/data/ni_covid_local.csv")

inpatient_df <- readr::read_csv("https://raw.githubusercontent.com/obrienjoey/covid19northernireland/main/data/ni_inpatients.csv")

hosp_df <- readr::read_csv("https://raw.githubusercontent.com/obrienjoey/covid19northernireland/main/data/ni_covid_hospital.csv")
...
inpatient_df %>%
  ...
  plot_ly(type = 'scatter', x = ~date, y = ~covid_patients, 
          color = ~age_band, mode = 'none', 
          stackgroup = 'one') %>%
